...
export const lynk01ProductFacts: AcademyFact[] = [
  ...
  {
    id: "01pt-controls-modes",
    topic: "NEW 01 controls / working modes",
    text: "5 controls / 17 working modes（视频）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co NEW 01",
    captured: "2026-09-05",
    tags: ["01", "EM-P"],
  ...
  {
    id: "01pt-adas-functions",
    topic: "NEW 01 ADAS function count",
    text: "18 ADAS functions（视频；传感器布局仍见 3R1V）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co NEW 01",
    captured: "2026-09-05",
    tags: ["01", "ADAS"],
  ...
  {
    id: "01pt-crash-compare-speeds",
    topic: "NEW 01 course crash comparison speeds",
    text: "课内碰撞对比速度：72 vs 64、64 vs 56、84 vs 80 km/h — 课内对比示数，未标明对比对象勿外推",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co NEW 01",
    captured: "2026-09-05",
    tags: ["01", "safety"],
  ...
  {
    id: "01pt-video-progress",
    topic: "NEW 01 video / course progress",
    text: "主视频 Learning completed 100%；整课进度 UI ~18%（其余章节未强制开；Exam/Evaluate 未开）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co NEW 01",
    captured: "2026-09-05",
    tags: ["01"],
...
export const ARCH_SEEDS: ArchSeed[] = [
  ...
  },
  {
    ...
    oneLiner:
      "Urban Utility Compact SUV · CMA（非Evo标签）· 4545×1860×1694/WB2734/0.605 · P1+P2 3-DHT · BHE15-DFZ-A00 102kW/230Nm TE38.1% · 系统206/535 · 17.72kWh · WLTP>750 · 3R1V/8155 8TOPS · R19 · 5 controls/17 modes · 18 ADAS · ≠08 280/436·39.6·TE44.26%；视频100%/课UI~18%",
    sourceBadge: "极氪学",
