...
export const lynk02BevProductFacts: AcademyFact[] = [
  {
    ...
    text: "Lynk & Co 02 (BEV) Product Training = Compact Coupe SUV / Premium Sporty E-SUV · SEA · RWD；课进度：6 PPT 100% · 视频 Learning completed 100%（总长 02:43:55）· Quiz 未开 — 本课 ≠ 06 ICE ≠ 01/08 EM-P；≠ 国内 CMA 02 Hatchback",
    sourceBadge: "极氪学",
  ...
  {
    id: "02bev-aero-cd",
    topic: "02 BEV aero Cd / range claim",
    text: "Cd 0.259；课内宣称相对对比车型续航 +46.9 km（视频）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV", "aero"],
  ...
  {
    id: "02bev-viewing-blocking",
    topic: "02 BEV viewing angles / blocking",
    text: "视野角 111° / 85°；遮挡 >99% / >95%（视频）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV"],
  ...
  {
    id: "02bev-side-seal",
    topic: "02 BEV side-seal NVH / patents",
    text: "侧封 side-seal：0 wind-noise leakage；语音清晰度 +2%；3 patents（视频）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV", "NVH"],
  ...
  {
    id: "02bev-steering",
    topic: "02 BEV steering response / precision",
    text: "转向响应 50 ms / 精度 0.1（视频）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV", "chassis"],
  ...
  {
    id: "02bev-rear-seat",
    topic: "02 BEV rear seat construction",
    text: "后排座椅 7-layer（视频）",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV"],
  ...
  {
    id: "02bev-niro-height-dual",
    topic: "02 BEV Niro height dual (PPT vs video)",
    text: "竞品表 Niro EV 高度：PPT 1545 mm vs 视频 1570 mm — dual 保留，勿塌缩",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV", "competitors"],
  },
  {
    id: "02bev-video-progress",
    topic: "02 BEV video / course progress",
    text: "PPT 6 份 100%；主视频 Learning completed 100%（总长 02:43:55）；Quiz 未开",
    sourceBadge: "极氪学",
    course: "Product Training of Lynk & Co 02 (BEV)",
    captured: "2026-09-05",
    tags: ["02-BEV"],
...
// ─── [Spanish] ZEEKR X Product Training (极氪学; captured 2026-09-05) ───────

export const zeekrXSpanishProductFacts: AcademyFact[] = [
  {
    id: "x-es-identity",
    topic: "[Spanish] X Product Training identity / progress",
    text: "[Spanish] ZEEKR X Product Training · PPT 已摘（2026-09-05）；视频因 seek 限制未完整看完；Quiz 未开 — ≠ 2026 New Model Introduction（双 badge）",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
    tags: ["x", "spanish"],
  },
  {
    id: "x-es-dims",
    topic: "[Spanish] X dimensions",
    text: "4432×1836×1566 · WB 2750 — ≠ Lynk 02 竞品表 X 4450×1836×1572（同 WB2750）— 分课 dual-badge",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
  ...
  {
    id: "x-es-prem-rwd",
    topic: "[Spanish] X Premium RWD",
    text: "Premium RWD：200 kW / 272 HP · 343 N·m · 0–100 5.6 s · 100–0 34.5 m — 后表另印 Prem 268 HP（vs 272）须 dual-badge",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
    tags: ["x", "spanish", "motor"],
  },
  {
    id: "x-es-flag-awd",
    topic: "[Spanish] X Flagship AWD",
    text: "Flagship AWD：315 kW / 428 HP · 543 N·m · 0–100 3.8 s · 100–0 34.5 m",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
    tags: ["x", "spanish", "motor", "AWD"],
  },
  {
    id: "x-es-pack-charge",
    topic: "[Spanish] X pack / charge",
    text: "包 66 kWh Li-ion；DC 150 kW · 10–80% 30 min；AC 22 kW / 0–100 4 h · 11 kW / 0–100 7.5 h — 本课未展示 Std 61 LFP",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
    tags: ["x", "spanish", "battery"],
  },
  {
    id: "x-es-awd-range",
    topic: "[Spanish] X AWD range table",
    text: "竞品表 AWD 续航 420 km（本课未给 RWD 续航）— ≠ Lynk 02 竞品表 X 440；≠ 2026 课 WLTC Prem 445 / Flag 415 — 三源 dual-badge",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training · Lynk 02 BEV · 2026 X New Model",
    captured: "2026-09-05",
    tags: ["x", "spanish", "02-BEV"],
  },
  {
    id: "x-es-safety",
    topic: "[Spanish] X safety claims",
    text: "5-star；7 airbags + additional side airbag；NTP thermal-propagation · emergency cut-off · active cooling · pack evacuation",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
    tags: ["x", "spanish", "safety"],
  },
  {
    id: "x-es-dual-badge-vs-2026",
    topic: "[Spanish] X dual-badge vs 2026 New Model Introduction",
    text: "西语产品课 ≠ 2026 New Model：Prem 峰 200 kW（272/268 HP dual）vs 2026 Prem 250 kW；Flag 315 kW/428 HP/3.8 s vs 2026 Flag 365 kW(250+115)/3.7 s；西语仅示 66 kWh（Std 61 LFP 仅 2026 课）；AWD 表续航 420 ≠ 2026 WLTC Prem445/Flag415；尺寸 4432×1836×1566 — 双 badge，勿合并一行",
    sourceBadge: "极氪学",
    course: "[Spanish] ZEEKR X Product Training · 2026 ZEEKR X New Model Introduction",
    captured: "2026-09-05",
    tags: ["x", "spanish"],
  },
  {
    id: "x-es-video-incomplete",
    topic: "[Spanish] X video incomplete",
    text: "视频因 seek 限制未完整看完；Quiz 未开 — 勿把本遍写成视频 100%",
    sourceBadge: "待补",
    course: "[Spanish] ZEEKR X Product Training",
    captured: "2026-09-05",
    tags: ["x", "spanish"],
...
export const academyTraps: AcademyTrap[] = [
  ...
  },
  {
    ...
    right: "同表并列：02 200 kW / 5.5 s vs X 428 Ps / 3.8 s — 勿塌缩；X 分档详参看 2026 X / [Spanish] X 产品课（双 badge）",
    sourceBadge: "极氪学",
    tags: ["02-BEV", "x", "competitors"],
  },
  {
    id: "trap-x-es-vs-2026",
    wrong: "把西语 X 产品课与 2026 New Model Introduction 动力/续航/配置合成一行唯一口径",
    right: "西语：[Spanish] Prem 200 kW（272/268 HP dual）· Flag 315 kW/428 HP/3.8 s · 66 only · AWD 表续航 420 · 4432×1836×1566；2026：Prem/Flag 250/365 kW · Flag 3.7 s · Std 61 LFP · WLTC Prem445/Flag415 — dual-badge 标明课名",
    sourceBadge: "极氪学",
    tags: ["x", "spanish"],
  },
  {
    id: "trap-x-es-hp-272-vs-268",
    wrong: "只报 272 HP 或只报 268 HP 当西语课 Prem 唯一马力",
    right: "西语课 trim 页 Prem 272 HP；后表另印 268 HP — dual-badge 脚注双值",
    sourceBadge: "极氪学",
    tags: ["x", "spanish"],
  },
  {
    id: "trap-x-es-range-420",
    wrong: "把西语 AWD 420、02 竞品表 X 440、2026 WLTC 445/415 互覆写",
    right: "西语竞品表 AWD 420 ≠ Lynk 02 竞品表 X 440 ≠ 2026 WLTC Prem 445 / Flag 415 — 三源分 badge",
    sourceBadge: "极氪学",
    tags: ["x", "spanish", "02-BEV"],
  },
  {
...
export const ARCH_SEEDS: ArchSeed[] = [
  ...
  },
  {
    ...
    oneLiner:
      "SEA RWD · Compact Coupe SUV · 4460×1845×1573/WB2755 · 200kW/343Nm/5.5s · 66kWh NCM · WLTC 465/435 · 4.5C 10–80 30min · V2L 3.3 · Brembo 17 · 100–0 34.19/34.33 dual · moose 81.7 · 22 HW/16 ADAS · 能耗 17.6 · Cd0.259/+46.9km · 视野111°/85° · side-seal 0泄漏/+2%语音/3patents · 转向50ms/0.1 · 后排7-layer · 竞品 Atto3/ID.3/Niro(高1545/1570 dual)/ZEEKR X · PPT+视频100% · ≠06 ICE ≠01/08 EM-P · 尺寸近Z20勿映射",
    sourceBadge: "极氪学",
  ...
  },
  {
    ...
    name: "[Spanish] ZEEKR X Product Training",
    nameZh: "极氪 X 西语产品课",
    oneLiner:
      "4432×1836×1566/WB2750 · Prem RWD 200kW/272HP(表268 dual)/343Nm/5.6s · Flag AWD 315kW/428HP/543Nm/3.8s · 100–0 34.5 · 66kWh · DC150 10–80 30min · AC22/4h·11/7.5h · AWD表续航420（≠02表440≠2026 WLTC445/415）· Std61仅2026课 · 视频未完 · vs2026 200≠250·315/3.8≠365/3.7 dual-badge",
    sourceBadge: "极氪学",
    factIds: zeekrXSpanishProductFacts.map((f) => f.id),
    trapIds: [
      "trap-x-es-vs-2026",
